...
include_once("../../Dao/Relatorios/RelatoriosFluxoCaixaDao.php");
class RelatoriosFluxoCaixaModel extends BaseModel
{
    function RelatoriosFluxoCaixaModel(){
        If (!isset($_SESSION)){
            ob_start();
            session_start();
        }
    ...
    Function BuscaFluxo(){
        $dao = new RelatoriosFluxoCaixaDao();
